...
The engine and clock-management layer were wrapped in a Shiny app (`app.R`) and deployed publicly via shinyapps.io, making the tool aaccessible through a live, interactive interface rather than requiring users to run R code directly
